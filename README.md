...
A curated, open collection of **52** satellite, topographic, nautical, trail and
...
<sub>Scan to add all 52 maps</sub>
</td>
<td>
...
| Bing | Bing - Hybrid | 1–20 | png | TMS |
| Bing | Bing - Maps | 1–20 | png | TMS |
| Bing | Bing - Satellite | 1–20 | jpg | TMS |
| BLM | BLM - Land Ownership (SMA) | 1–14 | jpg | TMS |
| BLM | BLM - Satellite + Land Ownership | —–— | — | Multi-Layer |
| cycleosm | CycleOSM - OSM Cycle | 0–20 | png | TMS |
| ESRI | Esri - Clarity | 1–19 | jpg | TMS |
...
| Google | Google - Hybrid No Poi | 0–20 | jpg | TMS |
...
| GRG | GRG - Google Road Only Overlay | 2–20 | jpg | TMS |
| GRG | GRG - Google Terrain Shading Overlay | 0–18 | jpg | TMS |
| GRG | GRG - WaymarkedTrails Cycle Routes Overlay | 0–18 | png | TMS |
| michelin | Michelin - OSM Michelin | 5–19 | — | TMS |
| mtbmapcz | MTBMap.cz - MTB Map Europe | 0–18 | png | TMS |
...
| TaiwanMaps | Taiwan - B5000 Topographic | 7–18 | png | TMS |
| TaiwanMaps | Taiwan - EMAP2 Transparent | 1–19 | png | TMS |
| TaiwanMaps | Taiwan - EMAP5 | 1–19 | jpg | TMS |
| TaiwanMaps | Taiwan - EMAP7 English Transparent | 1–19 | png | TMS |
| TaiwanMaps | Taiwan - EMAP8 English | 1–19 | jpg | TMS |
| TaiwanMaps | Taiwan - EMAP96 | 8–19 | png | TMS |
| TaiwanMaps | Taiwan - EMAP98 | 8–19 | png | TMS |
| TaiwanMaps | Taiwan - Government Area Boundaries | 7–19 | png | TMS |
| TaiwanMaps | Taiwan - Photo | 1–19 | jpg | TMS |
| TaiwanMaps | Taiwan - Photo Mix | 1–19 | jpg | TMS |
| TaiwanMaps | Taiwan - Village Boundaries | 6–17 | png | TMS |
...
## Taiwan-tested package

All sources were tested at a Taichung coordinate through their configured zoom
range. The test result and package decision for every XML file are recorded in
[`map-tests/taiwan-taichung.json`](map-tests/taiwan-taichung.json), with a
human-readable summary in the
[Taiwan coverage profile](docs/taiwan-map-coverage.md). Package generation
stops if the profile is missing an XML source or contains a stale path.

The recommended 14-source package is defined separately in
[`package-profiles/taiwan-essential.json`](package-profiles/taiwan-essential.json).
All release archives are ATAK Mission Package v2 Data Packages: map files are
stored under `content/`, referenced by `MANIFEST/manifest.xml`, and declared as
